 ...
 * delegate object as part of the sequence of editing text. All of the methods
 ...
 *
 *  @return Returns	@c YES if the keyboard should implement its default
 * behavior for the return button; otherwise, @c NO.
 */
...
/**
 *  Initializes and returns a number keyboard view using the specified style
 * information and locale.
 *
 *  An initialized view object or @c nil if the view could not be initialized.
 *
 *  @param frame          The frame rectangle for the view, measured in points.
 * The origin of the frame is relative to the superview in which you plan to add
 * it.
 *  @param inputViewStyle The style to use when altering the appearance of the
 * view and its subviews. For a list of possible values, see @c UIInputViewStyle
 *  @param locale         An @c NSLocale object that specifies options
 * (specifically the @c NSLocaleDecimalSeparator) used for the keyboard. Specify
 * @c nil if you want to use the current locale.
 *
 ...
 *
 *  @note The default value of this property is @c
 * MMNumberKeyboardButtonStyleDone.
 */
